...
- Для WB метрика «добавили в корзину» недоступна напрямую в используемых статистических endpoint и выводится как `н/д`.
- Метрика позиции в поиске/каталоге OZON может быть недоступна для части аккаунтов (в этом случае `н/д`).
