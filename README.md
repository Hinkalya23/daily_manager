...
- `WB_CAMPAIGN_NAME_SYMBOL` — символ в начале названия рекламной кампании WB для метрик рекламы (по умолчанию `!`, пример: `!Кампания`; если оставить пустым, будут учитываться все кампании)
